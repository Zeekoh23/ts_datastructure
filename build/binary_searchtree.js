...
class BinarySearchTree {
    ...
    breadthFirstSearch() {
        ...
        let queue = []; //keep track of the level we are to access their children
        ...
        while (queue.length > 0) {
            ...
            list.push(currentNode === null || currentNode === void 0 ? void 0 : currentNode.value); //adds the value to the list
